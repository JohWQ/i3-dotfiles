...
export EDITOR='nvim'
export VISUAL='nvim'
export FZF_DEFAULT_COMMAND='fd -H -t f -E "/.snapshots" -E "/home/.snapshots"'
...
###z4h source MichaelAquilina/zsh-auto-notify/auto-notify.plugin.zsh
...
alias i3statusconfig='sudo nvim ~/.config/i3status-rust/config.toml'
alias picomconfig='sudo nvim ~/.config/picom/picom.conf'

alias check='~/.config/scripts/check_package.sh'
alias localsend='sudo systemctl stop firewalld.service && /usr/local/bin/localsend; sudo systemctl start firewalld.service'
...
compdef _gnu_generic fpaste pastel picom lightdm betterlockscreen pw-cli
