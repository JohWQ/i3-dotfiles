...
alias i3statusconfig='nvim /home/jw/.config/i3status-rust/config.toml'
...
alias nogui='systemctl set-default multi-user.target && ~/.config/scripts/power/reboot.sh'
alias yesgui='systemctl set-default graphical.target && ~/.config/scripts/power/reboot.sh'
# ---------------------------
...
# ----- jw autocorrect ----- # autocorrect quirks
# opts to enable
#setopt correctall
...
compdef _gnu_generic fpaste pastel picom lightdm betterlockscreen pw-cli pw-dump dnf diff eza rofi xrandr
# ----- autocorrect ----- #
